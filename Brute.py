...
def tokenz():
	...
	try:
		...
		os.system('clear')
		logo()
		print(" %s\033[1;94m[☆] \033[1;94m =========================================================="%(N))
		print(" \033[1;94m[®] \033[1;94m Author     : ☆ RAKA ☆ ™︻®╤───────═◍➤")
		print(" \033[1;94m[®] \033[1;94m Github     : https://github.com/Bangsat-XD")
		print(" \033[1;94m[®] \033[1;94m Facebook   : Raka Andrian Tara")
